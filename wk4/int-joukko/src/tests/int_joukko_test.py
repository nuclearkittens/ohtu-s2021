...
class TestIntJoukko(unittest.TestCase):
    def setUp(self):
        ...
        self.joukko.lisaa_joukkoon(10)
        self.joukko.lisaa_joukkoon(3)

    def tee_joukko(self, *luvut):
        joukko = IntJoukko()

        for luku in luvut:
            joukko.lisaa_joukkoon(luku)
    ...
    def test_palautetaan_oikea_taulukko(self):
        ...
        self.joukko.lisaa_joukkoon(55)
        self.joukko.poista(10)
        self.joukko.lisaa_joukkoon(99)
